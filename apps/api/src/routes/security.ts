...
const CONTROLS = [
  ...
  },
  {
    ...
    enforcedBy: 'apps/api/src/workers/metadata.ts — startRun() refuses and handleMetadataJob() cancels'
  },
  {
    ...
    enforcedBy: 'apps/api/src/lib/webhooks.ts — emitEvent() and deliver() both refuse'
  }
] as const
