...
const SOURCE = readFileSync(new URL('../src/features/themes/themes.js', import.meta.url), 'utf8')
const STORE = readFileSync(new URL('../src/shared/state/store.js', import.meta.url), 'utf8')
