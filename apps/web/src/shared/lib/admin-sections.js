...
export const ADMIN_GROUPS = [
  ...
  /*
   * KIFELÉ MENŐ INTEGRÁCIÓK.
   *
   * A webhookok és a Discord tartós üzenetei ugyanaz a család: mindkettő azt
   * mondja meg, MIT KÜLDÜNK KI a nevünkben egy idegen rendszerbe. Eddig
   * mindkettő az „Üzemeltetés" alatt volt, ami nyolcra hizlalta azt a
   * csoportot — a `audit-status` teszt szerint hétnél több szekció már
   * „lerakat", és igaza van: egy nyolcelemű menüben nem lehet keresni.
   *
   * A szétválasztás nem csak számtani: aki azt kérdezi, „mi megy ki a
   * Discordra", az nem a hibanaplók és a mentések között fogja keresni.
   */
